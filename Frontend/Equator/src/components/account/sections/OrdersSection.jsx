...
function OrderRow({ order, isLast }) {
  ...
  return (
    <div className="grid md:grid-cols-5 gap-3 px-5 py-4 items-center text-sm" style={{ borderBottom: isLast ? "none" : "1px solid var(--color-equator-beige)", fontFamily: "var(--font-body)" }}>
